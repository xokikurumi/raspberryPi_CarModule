...
"color: #FFFFFF;"));
        ...
        gridLayout_2->addWidget(fanL, 2, 1, 1, 1);
...
"color: #FFFFFF;"));
        ...
        gridLayout_2->addWidget(usbR, 2, 4, 1, 1);
...
"color: #FFFFFF;"));
        ...
        gridLayout_2->addWidget(usbL, 2, 0, 1, 1);
        ...
        gridLayout_2->addWidget(tripB, 0, 3, 1, 1);
        ...
        gridLayout_2->addWidget(endBtn, 0, 1, 1, 1);
...
"border-color: solid 1px #FFFFFF;"));
        ...
        gridLayout_2->addWidget(tripA, 0, 4, 1, 1);
...
"border-color: solid 1px #FFFFFF;"));
        ...
        gridLayout_2->addWidget(tripReset, 0, 2, 1, 1);
...
"color: #FFFFFF;"));
        ...
        gridLayout_2->addWidget(fanR, 2, 3, 1, 1);
...
"border: solid 1-x #FFFFFF;"));
        ...
        gridLayout_2->addWidget(hazard, 1, 0, 1, 1);
